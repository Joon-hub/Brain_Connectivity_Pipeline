...
HEMISPHERE="both"
RESULTS_DIR="data/results/hemisphere_analysis/${HEMISPHERE}_hemisphere/compare_strategies"
...
REQUIRED=("data/processed/hemispheres" "configs" "scripts/hemisphere/05_compare_strategies.py" "$CONFIG_FILE")
