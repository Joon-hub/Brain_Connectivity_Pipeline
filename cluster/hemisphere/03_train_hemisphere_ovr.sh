...
HEMISPHERE="both"
RESULTS_DIR="data/results/hemisphere_analysis/${HEMISPHERE}_hemisphere/ovr"
...
REQUIRED=("data/processed/hemispheres" "configs" "scripts/hemisphere/03_train_hemisphere_ovr.py" "$CONFIG_FILE")
