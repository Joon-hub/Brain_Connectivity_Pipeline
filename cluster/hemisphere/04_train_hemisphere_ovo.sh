...
HEMISPHERE="both"
RESULTS_DIR="data/results/hemisphere_analysis/${HEMISPHERE}_hemisphere/ovo"
...
REQUIRED=("data/processed/hemispheres" "configs" "scripts/hemisphere/04_train_hemisphere_ovo.py" "$CONFIG_FILE")
