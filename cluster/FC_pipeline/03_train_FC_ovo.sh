...
FC="ovo"
RESULTS_DIR="data/results/FC_analysis/${FC}_FC/ovo"
...
# REQUIRED=("data/processed/FCs" "configs" "scripts/FC/02_train_FC_ovo.py" "$CONFIG_FILE")
...
# Run Training
python scripts/full_connectivity/03_train_FC_ovo.py \
      --tune_hyperparams \
      --optuna_trials 50 \
      --n_folds 5 \
      --test_on_task
